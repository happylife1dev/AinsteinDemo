...
namespace AinsteinDemo.Services
{
    using System;
    ...
    public class ConfigValidatorService
    {
        ...
        public static readonly Guid AustraliaId = GetParamGuid(ConfigurationManager.AppSettings["australiaId"]);
        public static readonly Guid HiddenId = GetParamGuid(ConfigurationManager.AppSettings["hiddenId"]);
        public static readonly Guid CheckupId = GetParamGuid(ConfigurationManager.AppSettings["checkupId"]);
        public static readonly Guid IndustryId = GetParamGuid(ConfigurationManager.AppSettings["industryId"]);
        public static readonly Guid IssuerId = GetParamGuid(ConfigurationManager.AppSettings["issuerId"]);
        public static readonly Guid CompanyDetailID = GetParamGuid(ConfigurationManager.AppSettings["companyDetailId"]);
        public static readonly Guid EarningsChartID = GetParamGuid(ConfigurationManager.AppSettings["earningsChartId"]);
        public static readonly Guid RevenueChartID = GetParamGuid(ConfigurationManager.AppSettings["revenueChartId"]);
        public static readonly Guid CashFlowChartID = GetParamGuid(ConfigurationManager.AppSettings["cashFlowChartId"]);

        
        public static readonly Guid SubindustryId = GetParamGuid(ConfigurationManager.AppSettings["subindustryId"]);
        public static readonly Guid TrialindustryId = GetParamGuid(ConfigurationManager.AppSettings["trialindustryId"]);
        public static readonly Guid NewearningsId = GetParamGuid(ConfigurationManager.AppSettings["newearningsId"]);
