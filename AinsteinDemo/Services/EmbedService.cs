...
namespace AinsteinDemo.Services
{
    ...
    public static class EmbedService
    {
        ...
        public static async Task<ReportEmbedConfig> GetEmbedParams(Guid workspaceId, Guid reportId, [Optional] Guid additionalDatasetId, [Optional] string strRouteIdValue)
        {
            using (var pbiClient = await GetPowerBiClient())
            {
                ...
                var embedReports = new List<EmbedReport>() {
                    new EmbedReport
                    {
                        ReportId = pbiReport.Id, ReportName = pbiReport.Name, EmbedUrl = pbiReport.EmbedUrl, RouteIdValue = strRouteIdValue
                    }
                };
        ...
        public static async Task<ReportEmbedConfig> GetEmbedParams2(Guid workspaceId, IList<Guid> reportIds, [Optional] IList<Guid> additionalDatasetIds)
        {
