    ...
    public class ETFController : Controller
    {
        ...
        /*public async Task<ActionResult> EmbedReport(int id)
        {
            ...
            try
            {
                ...
                theReportList.Add(ConfigValidatorService.AustraliaId); //assume issuer
        ...
        public async Task<ActionResult> Industry(int id)
        {
            if (!m_errorMessage.IsNullOrWhiteSpace())
            {
                return View("Error", BuildErrorModel(m_errorMessage));
            ...
            {
                System.Collections.Generic.IList<Guid> theReportList = new System.Collections.Generic.List<Guid>();
                theReportList.Add(ConfigValidatorService.TrialindustryId);
        ...
        public async Task<ActionResult> Issuer(int id)
        {
            if (!m_errorMessage.IsNullOrWhiteSpace())
            {
                return View("Error", BuildErrorModel(m_errorMessage));
            ...
            {
                System.Collections.Generic.IList<Guid> theReportList = new System.Collections.Generic.List<Guid>();
                theReportList.Add(ConfigValidatorService.IssuerId);
        ...
        public async Task<ActionResult> Constituents(int id)
        {
            if (!m_errorMessage.IsNullOrWhiteSpace())
            {
                return View("Error", BuildErrorModel(m_errorMessage));
